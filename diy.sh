...
git clone -b main https://github.com/xiaorouji/openwrt-passwall-packages.git package/lean/package  #passwall基本依赖
git clone -b main https://github.com/xiaorouji/openwrt-passwall.git package/lean/luci-app-passwall  #passwall出国软件
